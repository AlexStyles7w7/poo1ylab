...
public class App {
    public static void main(String[] args) {
        Triangulo triangulo1 = new Triangulo(new Punto(0, 5, 5), new Punto(0, 15, 15), new Punto(0, 5, 25));
        Triangulo triangulo2 = new Triangulo(new Punto(0, 15, 5), new Punto(0, 15, 15), new Punto(0,5, 25));
